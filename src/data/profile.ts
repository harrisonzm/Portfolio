...
export const projects: Project[] = [
  {
    ...
    impact:
      "50% improvement in resource organization and reuse; access enabled for 150+ teachers.",
    stack: [
      "React",
      "TypeScript",
      "Express.js",
  ...
  },
  {
    ...
    impact:
      "35% fewer delivery errors through stronger validations and controlled service orchestration.",
    stack: [
      "TypeScript",
      "Express.js",
      "TypeORM",
  ...
  },
  {
    ...
    impact:
      "35% faster response time, 20% higher decision accuracy, and 30% better retrieval accuracy.",
    stack: [
      "LangGraph",
      "LangChain",
      "ChromaDB",
  ...
  },
  {
    ...
    impact:
      "Improved collaboration and maintainability through architectural decoupling.",
    stack: [
      "React",
      "TypeScript",
      "Module Federation",
...
export const languages = [
  ...
  { name: "English", level: "Intermediate (B1–B2)", percent: 65 },
];
